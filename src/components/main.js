...
var Main = React.createClass({
  ...
  render: function() {
    ...
    return(
      <div>
        <div>
          <Navbar className="navv navbar-fixed-top p-0">
          <Navbar.Header>
            <Navbar.Brand>
              <a href="/" className="head p-0 "><i className="mdi mdi-account account2"> </i>  Contact</a>
            </Navbar.Brand>
            <Navbar.Toggle />
          </Navbar.Header>
          <Navbar.Collapse>
            <div className="nav navbar-nav navbar-right">
              ...
              <li style={{padding:10,cursor:'pointer'}} className="nav-item icon-parent ">
                        <a href="#" className=""  data-toggle="dropdown" aria-expanded="false"><i className=" fa fa-question-circle fa-lg "></i>
                        </a>
              ...
              <li style={{paddingTop:10,cursor:'pointer'}} className="nav-item pl-2 icon-parent">
                        <a href="#" class="" data-toggle="dropdown" aria-expanded="false"><i className="fa fa-cog fa-lg "></i></a>
                        <div className="dropdown-menu pull-right" >
